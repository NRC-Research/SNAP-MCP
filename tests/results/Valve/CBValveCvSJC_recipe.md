# Reconstruction Prompt: CBValveCvSJC
...
```
add_component(model_id, 'PIPE', 510, {}, initializer={
    "nsegs": 1,
    "n_pipes": 1,
    "length": 0.3,
    "hd": 0.6180387
...
```
add_component(model_id, 'PIPE', 520, {}, initializer={
    "nsegs": 1,
    "n_pipes": 1,
    "length": 0.3,
    "hd": 0.6180387
...
```
connect_components(model_id, 510, "inlet", "[JUN1] Inlet", 456, 1)
connect_components(model_id, 510, "outlet", "[JUN1] Inlet", 515, 1)
connect_components(model_id, 520, "inlet", "[JUN1] Inlet", 515, 1)
connect_components(model_id, 520, "outlet", "[JUN1] Inlet", 656, 1)
connect_components(model_id, 436, "inlet", "[JUN1] Inlet", 456, 1)
connect_components(model_id, 666, "inlet", "[JUN1] Inlet", 656, 1)
```
